...
//go:generate minimock -i github.com/Denis/project_auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
type AuthServiceMock struct {
	...
	funcCreate          func(ctx context.Context, info *model.AuthInfo) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, info *model.AuthInfo)
	...
	funcUpdate          func(ctx context.Context, id int64, info *model.AuthInfo) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, id int64, info *model.AuthInfo)
...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, info *model.AuthInfo) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) ExpectInfoParam2(info *model.AuthInfo) *mAuthServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, info *model.AuthInfo)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, info *model.AuthInfo) (i1 int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, info *model.AuthInfo) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *AuthServiceMock) Create(ctx context.Context, info *model.AuthInfo) (i1 int64, err error) {
...
func (mmGet *mAuthServiceMockGet) Return(ap1 *model.Auth, err error) *AuthServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthServiceMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &AuthServiceMockGetResults{ap1, err}
	mmGet.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGet.mock
}

// Set uses given function f to mock the AuthService.Get method
func (mmGet *mAuthServiceMockGet) Set(f func(ctx context.Context, id int64) (ap1 *model.Auth, err error)) *AuthServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *AuthServiceMockGetExpectation) Then(ap1 *model.Auth, err error) *AuthServiceMock {
	e.results = &AuthServiceMockGetResults{ap1, err}
	return e.mock
}
...
func (mmGet *AuthServiceMock) Get(ctx context.Context, id int64) (ap1 *model.Auth, err error) {
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, id int64, info *model.AuthInfo) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) ExpectInfoParam3(info *model.AuthInfo) *mAuthServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, info *model.AuthInfo)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, id int64, info *model.AuthInfo) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, id int64, info *model.AuthInfo) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, id int64, info *model.AuthInfo) (err error) {
