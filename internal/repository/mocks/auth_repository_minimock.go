...
//go:generate minimock -i github.com/Denis/project_auth/internal/repository.AuthRepository -o auth_repository_minimock.go -n AuthRepositoryMock -p mocks
...
type AuthRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, authInfo *model.AuthInfo) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, authInfo *model.AuthInfo)
	...
	funcGet          func(ctx context.Context, id int64) (ap1 *model.Auth, err error)
	...
	funcUpdate          func(ctx context.Context, id int64, authInfo *model.AuthInfo) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, id int64, authInfo *model.AuthInfo)
...
func (mmCreate *mAuthRepositoryMockCreate) Expect(ctx context.Context, authInfo *model.AuthInfo) *mAuthRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &AuthRepositoryMockCreateParams{ctx, authInfo}
...
// ExpectAuthInfoParam2 sets up expected param authInfo for AuthRepository.Create
func (mmCreate *mAuthRepositoryMockCreate) ExpectAuthInfoParam2(authInfo *model.AuthInfo) *mAuthRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.authInfo = &authInfo
	mmCreate.defaultExpectation.expectationOrigins.originAuthInfo = minimock.CallerInfo(1)

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the AuthRepository.Create
func (mmCreate *mAuthRepositoryMockCreate) Inspect(f func(ctx context.Context, authInfo *model.AuthInfo)) *mAuthRepositoryMockCreate {
...
func (mmCreate *mAuthRepositoryMockCreate) Set(f func(ctx context.Context, authInfo *model.AuthInfo) (i1 int64, err error)) *AuthRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthRepositoryMockCreate) When(ctx context.Context, authInfo *model.AuthInfo) *AuthRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &AuthRepositoryMockCreateParams{ctx, authInfo},
...
func (mmCreate *AuthRepositoryMock) Create(ctx context.Context, authInfo *model.AuthInfo) (i1 int64, err error) {
	...
	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, authInfo)
	}

	mm_params := AuthRepositoryMockCreateParams{ctx, authInfo}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockCreateParams{ctx, authInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.authInfo != nil && !minimock.Equal(*mm_want_ptrs.authInfo, mm_got.authInfo) {
				mmCreate.t.Errorf("AuthRepositoryMock.Create got unexpected parameter authInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreate.CreateMock.defaultExpectation.expectationOrigins.originAuthInfo, *mm_want_ptrs.authInfo, mm_got.authInfo, minimock.Diff(*mm_want_ptrs.authInfo, mm_got.authInfo))
			}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, authInfo)
	}
	mmCreate.t.Fatalf("Unexpected call to AuthRepositoryMock.Create. %v %v", ctx, authInfo)
	return
}
...
func (mmGet *mAuthRepositoryMockGet) Return(ap1 *model.Auth, err error) *AuthRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthRepositoryMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &AuthRepositoryMockGetResults{ap1, err}
	mmGet.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGet.mock
}

// Set uses given function f to mock the AuthRepository.Get method
func (mmGet *mAuthRepositoryMockGet) Set(f func(ctx context.Context, id int64) (ap1 *model.Auth, err error)) *AuthRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (e *AuthRepositoryMockGetExpectation) Then(ap1 *model.Auth, err error) *AuthRepositoryMock {
	e.results = &AuthRepositoryMockGetResults{ap1, err}
	return e.mock
}
...
func (mmGet *AuthRepositoryMock) Get(ctx context.Context, id int64) (ap1 *model.Auth, err error) {
...
func (mmUpdate *mAuthRepositoryMockUpdate) Expect(ctx context.Context, id int64, authInfo *model.AuthInfo) *mAuthRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthRepositoryMockUpdateParams{ctx, id, authInfo}
...
// ExpectAuthInfoParam3 sets up expected param authInfo for AuthRepository.Update
func (mmUpdate *mAuthRepositoryMockUpdate) ExpectAuthInfoParam3(authInfo *model.AuthInfo) *mAuthRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.paramPtrs.authInfo = &authInfo
	mmUpdate.defaultExpectation.expectationOrigins.originAuthInfo = minimock.CallerInfo(1)

	return mmUpdate
}

// Inspect accepts an inspector function that has same arguments as the AuthRepository.Update
func (mmUpdate *mAuthRepositoryMockUpdate) Inspect(f func(ctx context.Context, id int64, authInfo *model.AuthInfo)) *mAuthRepositoryMockUpdate {
...
func (mmUpdate *mAuthRepositoryMockUpdate) Set(f func(ctx context.Context, id int64, authInfo *model.AuthInfo) (err error)) *AuthRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthRepositoryMockUpdate) When(ctx context.Context, id int64, authInfo *model.AuthInfo) *AuthRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &AuthRepositoryMockUpdateParams{ctx, id, authInfo},
...
func (mmUpdate *AuthRepositoryMock) Update(ctx context.Context, id int64, authInfo *model.AuthInfo) (err error) {
	...
	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, id, authInfo)
	}

	mm_params := AuthRepositoryMockUpdateParams{ctx, id, authInfo}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockUpdateParams{ctx, id, authInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.authInfo != nil && !minimock.Equal(*mm_want_ptrs.authInfo, mm_got.authInfo) {
				mmUpdate.t.Errorf("AuthRepositoryMock.Update got unexpected parameter authInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmUpdate.UpdateMock.defaultExpectation.expectationOrigins.originAuthInfo, *mm_want_ptrs.authInfo, mm_got.authInfo, minimock.Diff(*mm_want_ptrs.authInfo, mm_got.authInfo))
			}
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, id, authInfo)
	}
	mmUpdate.t.Fatalf("Unexpected call to AuthRepositoryMock.Update. %v %v %v", ctx, id, authInfo)
	return
}
