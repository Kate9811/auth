...
func (m *CreateRequest) validate(all bool) error {
	...
	if _, ok := _CreateRequest_Role_NotInLookup[m.GetRole()]; ok {
		err := CreateRequestValidationError{
			field:  "Role",
...
var _CreateRequest_Name_Pattern = regexp.MustCompile("^[a-zA-Z0-9]+$")

var _CreateRequest_Role_NotInLookup = map[Role]struct{}{
	0: {},
}
